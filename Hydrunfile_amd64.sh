...
mkdir -p /tmp/tmp/build/bin
mkdir -p /tmp/tmp/lib/clang
mv /tmp/build/bin/clangd /tmp/tmp/build/bin
mv /tmp/build/lib/clang/* /tmp/tmp/lib/clang
cd /tmp/tmp
...
mkdir -p /data/out
mv /tmp/tmp/jupyter-clangd.$(uname -m).tar.gz /data/out
